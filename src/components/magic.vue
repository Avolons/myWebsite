  ...
  <div class="magicouter">
    <svg :width="400" :height="400" viewBox="0 0 800 800">
      <defs>
        ...
        <path :d="`M -${420 * Math.sqrt(2) / 2} 0 A ${420 * Math.sqrt(2) / 2} ${420 * Math.sqrt(2) / 2} 0 1 0 ${420 * Math.sqrt(2) / 2} 0 A ${420 * Math.sqrt(2) / 2} ${420 * Math.sqrt(2) / 2} 0 1 0 -${420 * Math.sqrt(2) / 2} 0`"
          id="text" transform="rotate(-60)"></path>
      </defs>
      <g :filter="`url(#blur${_uid})`" :transform="`translate(${width / 2}, ${height / 2})`">
        ...
        <g>
          <path v-for="i in 6" :d="`M 100 0 L ${200 * Math.cos(Math.PI / 180 * 360 / 12)} ${200 * Math.sin(Math.PI / 180 * 360 / 12)} L ${100 * Math.cos(Math.PI / 180 * 360 / 6)} ${100 * Math.sin(Math.PI / 180 * 360 / 6)} A 100 100 0 0 0 100 0`"
            :stroke="blue" :fill="background" :transform="`rotate(${i * 360 / 6})`"></path>
      ...
      <circle cx="0" cy="0" :r="`${210 / Math.sin(Math.PI / 4) + 5}`" :stroke="blue" fill="none"></circle> -->
        <g :transform="`rotate(${360 / 24})`">
          <text v-for="(font, i) in zodiac" font-family="Droid Sans" font-size="42.5" dy="0.35em" text-anchor="middle" :transform="`rotate(${360 / 12 * i})`"
        ...
        <g>
          ...
          <path v-for="i in 24" :transform="`rotate(${i * 360 / 24})`" :d="`M 0 -${420 * Math.sqrt(2) / 2 + 5} l 0 -20 A ${420 * Math.sqrt(2) / 2 + 25} ${420 * Math.sqrt(2) / 2 + 25} 0 0 1 ${(420 * Math.sqrt(2) / 2 + 25) * Math.sin(360 / 24 * Math.PI / 180)} ${(420 * Math.sqrt(2) / 2 + 25) * -Math.cos(360 / 24 * Math.PI / 180)} l -${20 * Math.sin(360 / 24 * Math.PI / 180)} ${20 * Math.cos(360 / 24 * Math.PI / 180)} A ${420 * Math.sqrt(2) / 2 + 5} ${420 * Math.sqrt(2) / 2 + 5} 0 0 0 0 -${420 * Math.sqrt(2) / 2 + 5}`"
            fill="none" :stroke="blue"></path>
        </g>

        <g>
          <!-- text in circles -->
          <text dy="-0.3em" font-family="" text-anchor="middle" v-for="i in 12" :transform="`rotate(${360 / 12 * i})`" :fill="blue"
            stroke="none">
        ...
        <g :transform="`rotate(90, 0, -${95 + (480 * Math.sqrt(2) / 2 - 95) / 2})`">
          <!--moon -->
          <path :d="`M 0 -95 A ${(480 * Math.sqrt(2) / 2 - 95) / 2} ${(480 * Math.sqrt(2) / 2 - 95) / 2} 0 1 1 0.0001 -95 z M 0 -100 A ${(480 * Math.sqrt(2) / 2 - 105) / 2} ${(480 * Math.sqrt(2) / 2 - 105) / 2} 0 1 0 -0.0001 -100 z`"
            :stroke="blue" :fill='background' fill-rule="evenodd"></path>
          <path :d="`M 0 -100 A ${(480 * Math.sqrt(2) / 2 - 100) / 2 * 2 / 3} ${(480 * Math.sqrt(2) / 2 - 100) / 2 * 2 / 3} 0 1 1 0.0001 -100 z M 0 -100 A ${(480 * Math.sqrt(2) / 2 - 100) / 2 / 2} ${(480 * Math.sqrt(2) / 2 - 100) / 2 / 2} 0 1 1 0.0001 -100 z`"
            :stroke="blue" :fill="background" fill-rule="evenodd"></path>
        </g>
...
@font-face {
    ...
    url('https://cdn.rawgit.com/reverland/blank/0aba7d84/mohojin-chinese-direction/Mohojin%20Chinese%20Direction.ttf') format('truetype'); /* chrome、firefox、opera、Safari, Android, iOS 4.2+*/
}
